...
Scenario: soap 1.1
  ...
  <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ent="http://contracts.it.nednet.co.za/Infrastructure/2008/09/EnterpriseContext" xmlns:mob="http://contracts.it.nednet.co.za/services/common-services/2014-10-01/MobileVerification">
   ...
   <soapenv:Body>
      <mob:RetrieveSimInformationRq>
         <mob:CommunicationIdentifier>27715035097</mob:CommunicationIdentifier>
      </mob:RetrieveSimInformationRq>
   </soapenv:Body>
</soapenv:Envelope>
    """
    When soap action 'http://contracts.it.nednet.co.za/services/common-services/2014-10-01/MobileVerification/RetrieveSimInformation'
    Then status 200
